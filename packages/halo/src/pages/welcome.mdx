...
name: Welcome
route: /
video: https://www.youtube.com/embed/mfEjrRpjjhM
---
...
<Bracket className="mb-8 max-w-2xl gap-6">
  <div>
    Halo is our design system. It streamlines UX development through reusable
    components, enabling product teams to ship rapidly.
  </div>
  <div className="flex-none">
    <a target="_blank" href="https://buildkite.com/angellist/halo">
      <img src="https://badge.buildkite.com/71f435fbeaf326479fce6ce41959cf3c7376de8d29367666a7.svg?branch=master" />
    </a>
    <a
      target="_blank"
      href="https://app.netlify.com/sites/halo-design-system/deploys"
    >
      <img
        src="https://api.netlify.com/api/v1/badges/87d1d78b-b9dc-440b-ba5a-90f89afce587/deploy-status"
        style={{ maxWidth: '88px' }}
      />
    </a>
  </div>
...
return (
  <Panel
    title="Welcome to AngelList"
    byline="Talent is our talent."
    className="max-w-lg gap-6"
  >
    <Bracket>
      <AvatarLockup
...
<Panel
  title="Welcome to AngelList"
  byline="Talent is our talent."
  className="mb-12 max-w-lg gap-6"
>
  <Bracket>
    <AvatarLockup
      imageUrl="https://avatars1.githubusercontent.com/u/194885"
